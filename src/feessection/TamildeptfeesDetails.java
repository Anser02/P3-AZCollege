...
public class TamildeptfeesDetails extends CreateConnection
{

	String qry;
	Connection c;

	public void Tamildept2023batchfp() throws SQLException
	{
		c=getConnection();		
		Statement st=c.createStatement();
		ResultSet rs;
		qry="select *from tamildeptstu where year_of_study='1';";
	...
	public void Tamildept2022batchfp() throws SQLException
	{
		c=getConnection();		
		Statement st=c.createStatement();
		ResultSet rs;
	...
	public void Tamildept2021batchfp() throws SQLException
	{
		c=getConnection();		
		Statement st=c.createStatement();
		ResultSet rs;
